...
from crossagents.abstractions.patterns import IAgentPattern, PatternDescriptor, PatternRiskLevel
...
from crossagents.core.pattern_selector import PatternSelector
